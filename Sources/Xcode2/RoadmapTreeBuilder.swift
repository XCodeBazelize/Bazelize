...
// MARK: - XCode.RoadmapTreeBuilder

extension XCode {
    public struct RoadmapTreeBuilder {
        ...
        public func build(project: XCode.Project) throws {
            ...
            try materializePrebuiltFiles(project: project)
        ...
        private func materializePrebuiltFiles(project: XCode.Project) throws {
