...
extension Starlark.Statement.Argument {
    ...
    public enum Visibility {
        ...
        public static let `public`: Starlark.Statement.Argument = "visibility" => ["//visibility:public"]
        /// "//visibility:private": Only targets in this package can use this target. (May not be combined with any other specification.)
        public static let `private`: Starlark.Statement.Argument = "visibility" => ["//visibility:private"]
        ...
        public static func package(_ packages: String...) -> Starlark.Statement.Argument {
        ...
        public static func subPackage(_ packages: String...) -> Starlark.Statement.Argument {
        ...
        public static func group(_ group: String, _ packages: String...) -> Starlark.Statement.Argument {
